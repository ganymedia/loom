...
- Completed Developer responses render as labeled, bordered `Developer summary` blocks; live streaming and other agents' completed output retain their existing presentation.
