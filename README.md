...
- Interactive terminals use a persistent Ink render tree with instant Tab agent cycling; streaming output, pinned scrollback/input regions, and full resize/exit handling remain in development for v0.1.1.
